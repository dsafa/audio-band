...
namespace AudioBand.Models
{
    ...
    public class PlayPauseButton : ModelBase
    {
        ...
        private double _xPosition = 370;
        private double _yPosition = 3;
        ...
        private ButtonContentType _playButtonContentType = ButtonContentType.Text;
        private ButtonContentType _pauseButtonContentType = ButtonContentType.Text;
