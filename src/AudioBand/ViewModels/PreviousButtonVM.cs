    ...
    public class PreviousButtonVM : ViewModelBase<PreviousButton>
    {
        ...
        public string ImagePath
        {
            ...
            set
            {
                ...
                {
                    Image = _resourceLoader.TryLoadImageFromPath(value, _resourceLoader.DefaultPreviousImage);
                }
            }
        }
        ...
        {
            Image = _resourceLoader.TryLoadImageFromPath(ImagePath, _resourceLoader.DefaultPreviousImage);
        }
