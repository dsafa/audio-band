...
namespace AudioBand.UI
{
    ...
    public class AboutDialogViewModel : ObservableObject
    {
        ...
        /// </summary>
        public string ProjectLink => "https://github.com/AudioBand/AudioBand";

        /// <summary>
        /// Gets the license link.
        /// </summary>
        public string LicenseLink => "https://github.com/AudioBand/AudioBand/blob/master/LICENSE";

        /// <summary>
        /// Gets the third party licenses link.
        /// </summary>
        public string ThirdPartyLicenseLink => "https://github.com/AudioBand/AudioBand/blob/master/LICENSE-3RD-PARTY";
