        ...
        private MapperConfiguration GetMapConfig()
        {
            var config = new MapperConfiguration(cfg =>
            {
                ...
                cfg.CreateMap<Models.V2.NextButtonSettings, NextButton>()
                    .ForMember(dest => dest.Content.HoveredImagePath, opt => opt.MapFrom(source => source.ImagePath))
                    .ForMember(dest => dest.Content.ClickedImagePath, opt => opt.MapFrom(source => source.ImagePath))
                    ...
                    .ForMember(dest => dest.Content.ContentType, opt => opt.MapFrom(source => ButtonContentType.Image))
                    .ForMember(dest => dest.Content.FontFamily, opt => opt.Ignore())
                    .ForMember(dest => dest.Content.Text, opt => opt.Ignore())
                    .ForMember(dest => dest.Content.TextColor, opt => opt.Ignore())
                    .ForMember(dest => dest.Content.HoveredTextColor, opt => opt.Ignore())
                    .ForMember(dest => dest.Content.ClickedTextColor, opt => opt.Ignore());
                ...
                cfg.CreateMap<Models.V2.PlayPauseButtonSettings, PlayPauseButton>()
                    ...
                    .ForMember(dest => dest.HoveredBackgroundColor, opt => opt.Ignore())
                    .ForMember(dest => dest.ClickedBackgroundColor, opt => opt.Ignore())
                    .ForMember(dest => dest.PlayContent.HoveredImagePath, opt => opt.MapFrom(source => source.PlayButtonImagePath))
                    .ForMember(dest => dest.PlayContent.ClickedImagePath, opt => opt.MapFrom(source => source.PlayButtonImagePath))
                    .ForMember(dest => dest.PauseContent.HoveredImagePath, opt => opt.MapFrom(source => source.PauseButtonImagePath))
                    .ForMember(dest => dest.PauseContent.ClickedImagePath, opt => opt.MapFrom(source => source.PauseButtonImagePath))
                    .ForMember(dest => dest.PlayContent.ContentType, opt => opt.MapFrom(source => ButtonContentType.Image))
                    .ForMember(dest => dest.PauseContent.ContentType, opt => opt.MapFrom(source => ButtonContentType.Image))
                    .ForMember(dest => dest.PlayContent.FontFamily, opt => opt.Ignore())
                    .ForMember(dest => dest.PauseContent.FontFamily, opt => opt.Ignore())
                    .ForMember(dest => dest.PlayContent.Text, opt => opt.Ignore())
                    .ForMember(dest => dest.PauseContent.Text, opt => opt.Ignore())
                    .ForMember(dest => dest.PlayContent.TextColor, opt => opt.Ignore())
                    .ForMember(dest => dest.PlayContent.HoveredTextColor, opt => opt.Ignore())
                    .ForMember(dest => dest.PlayContent.ClickedTextColor, opt => opt.Ignore())
                    .ForMember(dest => dest.PauseContent.TextColor, opt => opt.Ignore())
                    .ForMember(dest => dest.PauseContent.HoveredTextColor, opt => opt.Ignore())
                    .ForMember(dest => dest.PauseContent.ClickedTextColor, opt => opt.Ignore());
